...
function showCategories(content, data) {
  data.map((el) => {
    content.innerHTML += `
<a href="../pen/category.html?categoryName=${el.name}"
              class="dis-card relative bg-white shadow-lg shadow-[orangered] p-[20px] rounded-[5px] max-w-[260px] w-full h-[200px]"
            >
