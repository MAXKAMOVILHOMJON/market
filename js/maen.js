...
tor.map((el) => {
    pejak.innerHTML += `<div class="w-full   max-w-[160px] sm:max-w-[204px]  w-full  w-[260px] sm:w-[304px] md:w-[324px]   xl:max-w-[472px] max-h-[443px] sm:max-h-[449px] bg-[white] rounded-[4px] shadow-md hover:shadow-orange-300 hover:shadow-xl duration-300 my-5" >
             ...
             `: `` } 
             <button class="cursor-pointer w-[258px] w-full h-[40px] my-2 rounded-[4px] border-[1px] border-[#70C05B] text-[#70C05B] text-[16px] font-[400] font-rubik hover:bg-[#FF6633] hover:border-[#FF6633] hover:text-[white] duration-300"><a href="./pen/test.html?id=${el.id}">В корзину</a></button>
          </div>
         </div>
...
newi.map((el) => {
    Newitems.innerHTML += `<div class="w-full   max-w-[160px] sm:max-w-[204px]  w-full  w-[260px] sm:w-[304px] md:w-[324px]   xl:max-w-[472px] max-h-[443px] sm:max-h-[449px] bg-[white] rounded-[4px] shadow-md hover:shadow-orange-300 hover:shadow-xl duration-300 my-5" >
             <div class="relative w-full">
                 <img class="block w-full h-[100px] object-contain" style="max-width:324px; height:200px;" src="${el.images[0]}" alt="">
             <p class="text-[white] absolute left-[10px] bottom-[10px] px-[8px] py-[4px] bg-[#FF6633] rounded-[4px]">-${el.discount}%</p>
             <img style="width: 29px; height: 28px;" class="absolute top-[12px] right-[12px] p-[4px] rounded-[4px] bg-[#F3F2F1] opacity-[50%] cursor-pointer" src="../assets/images/articles/Frame 211.png" alt="">    
...
newi.map((el) => {
    before.innerHTML += `<div class="w-full   max-w-[160px] sm:max-w-[204px]  w-full  w-[260px] sm:w-[304px] md:w-[324px]   xl:max-w-[472px] max-h-[443px] sm:max-h-[449px] bg-[white] rounded-[4px] shadow-md hover:shadow-orange-300 hover:shadow-xl duration-300 my-5" >
             <div class="relative w-full">
                 <img class="block w-full h-[100px] object-contain" style="max-width:324px; height:200px;" src="${el.images[0]}" alt="">
             <p class="text-[white] absolute left-[10px] bottom-[10px] px-[8px] py-[4px] bg-[#FF6633] rounded-[4px]">-${el.discount}%</p>
             <img style="width: 29px; height: 28px;" class="absolute top-[12px] right-[12px] p-[4px] rounded-[4px] bg-[#F3F2F1] opacity-[50%] cursor-pointer" src="../assets/images/articles/Frame 211.png" alt="">    
